...
| AI QA, meeting, voiceprint | application state machine and phone media protocol | LVGL, BT messages; audio uses phone HFP |
...
Mic and speaker PCM are intentionally not part of the plugin ABI. Plugins send
control or state messages to the phone through the Bluetooth capability; the
phone's HFP connection owns microphone capture and speaker playback.
