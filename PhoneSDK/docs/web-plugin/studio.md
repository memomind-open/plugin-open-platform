...
| Capability | Desktop Studio | PhoneSDK Browser Studio |
| --- | --- | --- |
| Distribution | Prebuilt application under `Studio/<platform>/` | Public PhoneSDK source and DevKit ZIP |
...
or three plugin levels below a first-level collection directory in `PhoneSDK` and
...
From the public `PhoneSDK` directory, run:
