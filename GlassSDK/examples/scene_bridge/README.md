...
device-specific drawing locally as one GM plugin. It receives plugin command
`0x28` (`INT16 channel`, `BYTES payload`) and maps scene elements to the
...
| `0x7FFE` ping | opaque bytes, echoed back to the phone |
