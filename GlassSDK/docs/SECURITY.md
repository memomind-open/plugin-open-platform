...
trusted source. Use an official, trusted Studio build for simulation and package
sharing, and the official App for installation on physical glasses. The supported
workflow and omission of private transport details from public documentation do
not themselves authenticate a transport client.
...
See [PROTOCOL.md](PROTOCOL.md) for the supported installation workflow and [ABI.md](ABI.md) for
