...
#if LV_FONT_XGIMI_17
LV_FONT_DECLARE(lv_font_xgimi_17)
#endif

#if LV_FONT_XGIMI_INLINE
LV_FONT_DECLARE(lv_font_xgimi_inline)
#endif

#if LV_FONT_XGIMI_20
LV_FONT_DECLARE(lv_font_xgimi_20)
#endif

#if LV_FONT_XGIMI_WEATHER
LV_FONT_DECLARE(lv_font_xgimi_weather);
#endif

#if LV_FONT_XGIMI_EMO
LV_FONT_DECLARE(lv_font_xgimi_emo);
#endif
