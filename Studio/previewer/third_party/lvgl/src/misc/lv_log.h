...
#define LV_LOG_TRACE(fmt,...) do {}while(0)
#define LV_LOG_INFO(fmt, ...) do {}while(0)
#define LV_LOG_WARN(fmt,...) do {LOGW("[%d]" fmt, __LINE__, ##__VA_ARGS__);}while(0)
#define LV_LOG_ERROR(fmt,...) do {LOGE("[%d]" fmt, __LINE__, ##__VA_ARGS__);}while(0)
#define LV_LOG_USER(fmt,...) do {LOGR("[%d]" fmt, __LINE__, ##__VA_ARGS__);}while(0)
#define LV_LOG(fmt,...) do {LOGD("[%d]" fmt, __LINE__, ##__VA_ARGS__);}while(0)
